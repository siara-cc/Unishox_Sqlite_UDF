...
static void unishox1c(sqlite3_context *context, int argc, sqlite3_value **argv) {
  ...
  nOut2 = unishox1_compress((const char *) inBuf, nIn, (char *) &outBuf[vIntLen], NULL);
...
static void unishox1d(sqlite3_context *context, int argc, sqlite3_value **argv) {
  ...
  //nOut2 = (long int)nOut;
  nOut2 = unishox1_decompress((const char *) (inBuf + vIntLen), nIn - vIntLen, (char *) outBuf, NULL);
  //if( rc!=Z_OK ){
  //  free(outBuf);
  //}else{
